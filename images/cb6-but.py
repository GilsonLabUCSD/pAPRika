...
u'At': ((0.458824, 0.309804, 0.270588), 1, u'default'), u'In': ((0.65098, 0.458824, 0.45098), 1, u'default')}
	...
	modelAssociations = {}
	colorInfo = (9, (u'H', (1, 1, 1, 1)), {(u'green', (0, 1, 0, 1)): [1], (u'', (0.106829, 0.702586, 0.652042, 1)): [0], (u'N', (0.188235, 0.313725, 0.972549, 1)): [2], (u'', (1, 1, 1, 1)): [7], (u'O', (1, 0.0509804, 0.0509804, 1)): [4], (u'yellow', (1, 1, 0, 1)): [6], (u'cornflower blue', (0.392157, 0.584314, 0.929412, 1)): [5], (u'', (0.545455, 0, 1, 1)): [8]})
	viewerInfo = {'cameraAttrs': {'center': (0.031, -0.0945, 1.835), 'fieldOfView': 17.183565421784, 'nearFar': (9.0768353811706, -5.4068355123077), 'ortho': True, 'eyeSeparation': 50.8, 'focal': 1.835}, 'viewerAttrs': {'silhouetteColor': None, 'clipping': False, 'showSilhouette': False, 'showShadows': False, 'viewSize': 11.391911504425, 'labelsOnTop': True, 'depthCueRange': (0.5, 1), 'silhouetteWidth': 2, 'singleLayerTransparency': True, 'shadowTextureSize': 2048, 'backgroundImage': [None, 1, 2, 1, 0, 0], 'backgroundGradient': [('Chimera default', [(1, 1, 1, 1), (0, 0, 1, 1)], 1), 1, 0, 0], 'depthCue': True, 'highlight': 0, 'scaleFactor': 1.1936205300669, 'angleDependentTransparency': True, 'backgroundMethod': 0}, 'viewerHL': 8, 'cameraMode': 'mono', 'detail': 1.5, 'viewerFog': None, 'viewerBG': 7}
...
def restoreSession_RibbonStyleEditor():
	...
	userXSections = []
	userResidueClasses = []
	residueData = [(1, 'Chimera default', 'rounded', u'unknown'), (2, 'Chimera default', 'rounded', u'unknown')]
...
def restoreRemainder():
	...
	windowSize = (888, 678)
	xformMap = {0: (((-0.11624158307307, -0.87318323267119, 0.47332751509558), 18.779158484753), (0.50892550362133, -0.03438019354708, 0.061560056363412), True)}
